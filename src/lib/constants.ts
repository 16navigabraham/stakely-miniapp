 ...
 */
export const APP_NAME: string = 'stakely';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Put your money where your mouth is. Prove yourself on-chain and dominate the leaderboard';
 ...
 */
export const APP_SPLASH_BACKGROUND_COLOR: string = '#490088';
